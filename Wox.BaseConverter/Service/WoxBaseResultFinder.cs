...
{
    public class WoxBaseResultFinder : WoxResultFinder
    {
        ...
        public string VersionInformation
        {
            get
            {
                ...
                {
                    _versionInformation = "Wox-BaseConverter version {0}".FormatWith(SystemInformations.Version);
                }
                return _versionInformation;
            }
        }

        public WoxBaseResultFinder(IWoxContextService woxContextService, IBaseConvertService baseConvertService, ISystemInformations systemInformations, ISystemService systemService)
        ...
        private WoxResult GetCompletionResultForConvert(string baseOrig, string baseResult, string value)
        {
        ...
        private IEnumerable<WoxResult> GetConvertResults(WoxQuery query, int position)
        {
        ...
        private IEnumerable<WoxResult> GetVersionResults(WoxQuery query, int position)
        {
            return new List<WoxResult>()
            {
                new WoxResult
